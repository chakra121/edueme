    ...
    <div className="flex flex-col justify-center space-y-10 px-16 pb-8 pt-[8rem]">
      ...
      <div className="grid-row-2 grid">
        <div className="grid grid-cols-3 gap-7 px-6 py-3">
          {/* 3-4 */}
          <div className="transform space-y-3 rounded-lg border-2 border-orange-500 bg-orange-100 font-semibold text-orange-900 transition duration-500 ease-in-out hover:z-10 hover:-translate-y-1 hover:scale-105 hover:bg-orange-300 hover:text-orange-950">
