...
const Brief = () => {
  return (
    <div className="relative flex flex-col items-center justify-between space-y-4 py-[6rem]">
      <div className="relative flex flex-col justify-between bg-orange-100 px-24 py-6">
      ...
      <Link
        href="\courses"
        className="flex w-[8%] items-center rounded-2xl bg-orange-500 p-4 text-amber-950 transition duration-300 ease-in-out hover:scale-110 hover:bg-orange-400"
      >
        ← Go Back
      </Link>
    </div>
