  ...
  return (
    <div className="relative overflow-hidden pt-[7rem] text-gray-800 bg-gradient-to-b from-gray-50 to-white min-h-screen">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        >
          <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#3B82F6">
        ...
        >
          <svg viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg" fill="#3B82F6">
            ...
            <circle cx="60" cy="60" r="15" fill="#1D4ED8" />
          </svg>
        </div>
        ...
        >
          <svg viewBox="0 0 100 200" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#3B82F6">
            ...
            <circle cx="30" cy="180" r="5" fill="#3B82F6" />
        ...
        >
          <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" fill="#22C55E">
        ...
        >
          <svg viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg" fill="#F97316">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col items-center opacity-0 animate-fadeIn" style={{animation: "fadeIn 0.8s forwards"}}>
          ...
          <p className="mt-4 text-lg md:text-xl text-center text-gray-600 max-w-2xl opacity-0 animate-fadeIn" style={{animation: "fadeIn 1s 0.8s forwards"}}>
        ...
        <div className="mt-20 flex flex-col lg:flex-row items-center justify-center gap-12 opacity-0 animate-fadeIn" style={{animation: "fadeIn 1s 1s forwards"}}>
          ...
          <div className="relative w-full md:w-[400px] h-[400px] rounded-2xl overflow-hidden shadow-lg shadow-blue-500/10 hover:scale-105 transition-transform duration-300 animate-float">
            ...
            <div className="absolute top-4 right-4 w-12 h-12 opacity-70">
              <svg viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#3B82F6">
                ...
                <circle cx="45" cy="25" r="2" fill="#3B82F6" />
              </svg>
            </div>
          </div>
          ...
          <div className="max-w-xl w-full">
            <ul className="space-y-8">
              {[
                { icon: "📘", color: "yellow-500", text: "Hands-on Learning with Real Robotics Kits", delay: 0.2 },
                { icon: "🤖", color: "blue-500", text: "AI & Automation Integrated Curriculum", delay: 0.4 },
                { icon: "🚀", color: "green-500", text: "Industry Expert Mentorship & Guidance", delay: 0.6 },
                { icon: "🎓", color: "red-500", text: "Certifications & Future Career Support", delay: 0.8 }
              ].map((item, index) => (
                <li
                  key={index}
                ...
                >
                  ...
                  <span className="text-lg md:text-xl font-medium text-gray-700 group-hover:text-blue-700 transition-colors duration-300">{item.text}</span>
                  ...
                  <div className="ml-auto w-6 h-6 opacity-50 group-hover:opacity-100 transition-opacity duration-300">
                    {index === 0 && (
                      <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#EAB308">
                        <rect x="4" y="4" width="16" height="16" rx="2" />
                        <path d="M8,8 L16,8" stroke="#666" strokeWidth="1" />
                        <path d="M8,12 L16,12" stroke="#666" strokeWidth="1" />
                        <path d="M8,16 L12,16" stroke="#666" strokeWidth="1" />
                      </svg>
                    )}
                    {index === 1 && (
                      <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#3B82F6">
                        <circle cx="12" cy="12" r="6" />
                        <circle cx="10" cy="10" r="1" fill="#FFF" />
                        <circle cx="14" cy="10" r="1" fill="#FFF" />
                        <path d="M9,14 Q12,16 15,14" fill="none" stroke="#FFF" strokeWidth="1" />
                      </svg>
                    )}
                    {index === 2 && (
                      <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#22C55E">
                        <path d="M12,4 L8,12 L12,12 L12,20 L16,12 L12,12 Z" />
                      </svg>
                    )}
                    {index === 3 && (
                      <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#EF4444">
        ...
        <div className="mt-24 px-6 max-w-4xl mx-auto text-center relative opacity-0 animate-fadeInUp" style={{animation: "fadeInUp 0.8s forwards"}}>
          ...
          <div className="h-1 bg-blue-500 mt-4 mx-auto rounded-full w-0 animate-expandWidth" style={{animation: "expandWidth 1s 0.3s forwards"}}></div>
            ...
            {[
              ...
              >
                ...
                <div className="absolute bottom-2 right-2 w-12 h-12 opacity-20 group-hover:opacity-70 transition-opacity duration-300 animate-spin" style={{animation: "spin 20s linear infinite"}}>
                  {index === 0 && (
                    <svg viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" fill="#3B82F6">
                      <path d="M20,5 L25,15 L35,20 L25,25 L20,35 L15,25 L5,20 L15,15 Z" />
                      <circle cx="20" cy="20" r="5" fill="#2563EB" />
                    </svg>
                  )}
                  {index === 1 && (
                    <svg viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" fill="#22C55E">
                      <circle cx="20" cy="20" r="15" fill="none" stroke="#22C55E" strokeWidth="2" />
                      <circle cx="20" cy="20" r="10" fill="none" stroke="#22C55E" strokeWidth="2" />
                      <circle cx="20" cy="20" r="5" fill="#22C55E" />
                    </svg>
                  )}
                  {index === 2 && (
                    <svg viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" fill="#EAB308">
                      <rect x="5" y="5" width="30" height="30" fill="none" stroke="#EAB308" strokeWidth="2" />
                      <path d="M10,15 L15,10 L25,20 L15,30 L10,25 Z" />
                      <path d="M25,10 L30,15 L20,25 L30,25 L25,30 Z" />
                    </svg>
                  )}
                  {index === 3 && (
                    <svg viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" fill="#EF4444">
                      <circle cx="20" cy="20" r="15" fill="none" stroke="#EF4444" strokeWidth="2" />
                      <path d="M15,15 L25,25" stroke="#EF4444" strokeWidth="2" />
                      <path d="M15,25 L25,15" stroke="#EF4444" strokeWidth="2" />
                    </svg>
                  )}
                </div>
              </div>
        ...
        <div className="relative h-48 mt-12">
          ...
          >
            <svg viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg" fill="#9333EA">
              <path d="M25,10 C40,10 40,40 25,40 C10,40 10,10 25,10 Z" />
              <path d="M20,20 Q25,15 30,20" fill="none" stroke="#4C1D95" strokeWidth="1" />
              <path d="M15,25 Q25,30 35,25" fill="none" stroke="#4C1D95" strokeWidth="1" />
              <path d="M20,30 Q25,35 30,30" fill="none" stroke="#4C1D95" strokeWidth="1" />
            </svg>
          </div>
          ...
          >
            <svg viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg" fill="#3B82F6">
              <rect x="10" y="10" width="30" height="30" rx="2" />
              <rect x="15" y="15" width="20" height="20" rx="1" fill="#2563EB" />
              <path d="M5,20 L10,20" stroke="#3B82F6" strokeWidth="2" />
              <path d="M5,30 L10,30" stroke="#3B82F6" strokeWidth="2" />
              <path d="M40,20 L45,20" stroke="#3B82F6" strokeWidth="2" />
              <path d="M40,30 L45,30" stroke="#3B82F6" strokeWidth="2" />
              <path d="M20,5 L20,10" stroke="#3B82F6" strokeWidth="2" />
              <path d="M30,5 L30,10" stroke="#3B82F6" strokeWidth="2" />
              <path d="M20,40 L20,45" stroke="#3B82F6" strokeWidth="2" />
              <path d="M30,40 L30,45" stroke="#3B82F6" strokeWidth="2" />
            </svg>
          </div>
          ...
          >
            <svg viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#F97316">
