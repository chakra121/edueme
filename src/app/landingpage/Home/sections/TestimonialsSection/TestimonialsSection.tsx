...
// Ensure dynamic import is correctly configured
...
const ReviewCarousel = () => {
  ...
  return (
    <section className="flex flex-col items-center bg-white py-16 text-base-content transition-all duration-500">
