...
const allCardData = [
  // Left Cards (animate top to bottom)
  {
    ...
    description: "Fundamentals of robotic systems and components.",
    image: "/placeholder_image_1.webp",
    side: "left",
  },
  {
    id: "l2",
    ...
    description:
      "How AI powers intelligent robot behavior and decision making.",
    image: "/placeholder_image_2.webp",
    side: "left",
  },
  {
    id: "l3",
    title: "Sensor Technology",
    description: "Exploring various sensors: vision, lidar, tactile.",
    image: "/placeholder_image_3.webp",
    side: "left",
  },
  {
    id: "l4",
    ...
    description:
      "Algorithms for robot navigation and pathfinding in complex environments.",
    image: "/placeholder_image_4.webp",
    side: "left",
  },
  {
    id: "l5",
    title: "Robot Ethics",
    description: "Considering the ethical implications of advanced robotics.",
    image: "/placeholder_image_5.webp",
    side: "left",
  },
  ...
  {
    id: "r1",
    title: "Mini Robot Showcase",
    description: "Interactive 3D view of our featured mini robot.",
    image: "/coursebg.webp",
    side: "right",
  },
  {
    ...
    description:
      "Explore the interactive model with advanced controls and camera options.",
    image: "/coursebg.webp",
    side: "right",
  }, // Original card, modified
  {
    id: "r3",
    title: "Kinematics Deep Dive",
    description:
      "Understanding the study of motion without considering external forces.",
    image: "/placeholder_image_6.webp",
    side: "right",
  },
  {
    id: "r4",
    ...
    description:
      "Analyzing forces and torques that affect robot movement and stability.",
    image: "/placeholder_image_7.webp",
    side: "right",
  },
  {
    id: "r5",
    ...
    description:
      "Discover how robots are used in industry, healthcare, and exploration.",
    image: "/placeholder_image_8.webp",
    side: "right",
  },
];
...
const getImagePath = (path: string): string => {
  ...
  if (knownImages.includes(path) || path.startsWith("/placeholder_image_")) {
    // crude check
...
function Model() {
  const gltf = useGLTF("/mini_robot.glb") as unknown as { scene: THREE.Group };
  if (!gltf?.scene) {
    console.error("Failed to load GLTF model");
    return null;
  }
  const scene = gltf?.scene;
  if (!scene || !(scene instanceof THREE.Group)) {
    console.error("Scene is not a valid THREE.Group in the loaded GLTF model");
    return null;
  }
...
function InfoCard({
  ...
  return (
    ...
    >
      ...
      />
      <h3 style={{ margin: "15px 0 10px", fontSize: "1.2rem", color: "#333" }}>
        {title}
      </h3>
...
export default function ThreeDPage() {
  ...
  useEffect(() => {
    ...
    // Removed initial load effect timer as isInitialLoad is unused
  ...
  const visibleLeftCards = getVisibleCardsData(
    leftCardsData,
    currentLeftStartIndex,
  );
  const visibleRightCards = getVisibleCardsData(
    rightCardsData,
    currentRightStartIndex,
  );
    ...
    >
      <style jsx global>{`
        ...
        @keyframes initialSlideInLeft {
          ...
          to {
            transform: translateX(0) perspective(1000px) rotateX(0) rotateY(0);
            opacity: 1;
          }
        }
        ...
        @keyframes carouselEnterTopToBottom {
          from {
            ...
            opacity: 0;
          } /* Start a bit closer for smoother look */
          to {
        ...
        .card-initial-slide-left {
          animation: initialSlideInLeft 0.7s ease-out forwards;
        }
        .card-initial-slide-right {
          animation: initialSlideInRight 0.7s ease-out forwards;
        }
        .card-carousel-enter-ttb {
          animation: carouselEnterTopToBottom 0.7s ease-out forwards;
        } /* Top To Bottom */
        .card-carousel-enter-btt {
          animation: carouselEnterBottomToTop 0.7s ease-out forwards;
        } /* Bottom To Top */
      ...
      >
        ...
        <Suspense fallback={null}>
          {" "}
          {/* Use a proper loader for canvas if needed, e.g., Drei's Html + useProgress */}
          <Model />
        </Suspense>
        <OrbitControls
          minDistance={2}
