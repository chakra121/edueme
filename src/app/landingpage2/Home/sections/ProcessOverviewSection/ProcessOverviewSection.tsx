...
export const ProcessOverviewSection = (): JSX.Element => {
  ...
  return (
    <section className="flex flex-col items-start gap-[30px] w-full max-w-[1240px] mx-auto py-10">
      <Accordion type="single" collapsible className="w-full" defaultValue="01">
        {processSteps.map((step) => (
          ...
          >
            <AccordionTrigger className="flex w-full items-center justify-between px-[60px] py-[41px] hover:no-underline [&>svg]:hidden">
              ...
              <div 
                className="w-[58px] h-[58px] rounded-full border-2 border-[#191a23] flex items-center justify-center bg-white transition-colors duration-200 data-[state=open]:bg-[#ffb800]"
              >
                <PlusIcon className="w-8 h-8 text-[#191a23] block group-data-[state=open]:hidden" />
