        ...
        <section className="flex flex-col items-center justify-center py-16 bg-black text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                {points.map((point, index) => (
                    <div 
                        key={index} 
                        className="card bg-gray-900 shadow-xl hover:scale-105 hover:shadow-lg transition-transform duration-300 overflow-hidden h-[450px]"
                    >
                        ...
                        <div className="card-body h-1/2 flex flex-col justify-center">
                            ...
                            <p className="mt-2 text-lg text-gray-300">{point.description}</p>
                        </div>
                    </div>
                ))}
            </div>
