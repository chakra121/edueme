    ...
    return (
      <section className="flex flex-col items-center justify-center py-16 bg-black text-white">
        ...
        <div className="flex items-center justify-center">
          <div className="relative w-[415px] h-[475px] [perspective:1000px]">
            <div className="relative w-full h-full transition-transform duration-700 [transform-style:preserve-3d] hover:[transform:rotateY(180deg)]">
              {/* Front Side */}
              <div className="absolute inset-0 bg-cover bg-center rounded-lg [backface-visibility:hidden]" style={{ backgroundImage: "url('registerbg.jpg')" }}>
              ...
              <div className="absolute inset-0 bg-[#e3b6b5] rounded-lg flex flex-col items-center justify-center [transform:rotateY(180deg)] [backface-visibility:hidden]">
                ...
                <p className="text-lg text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad labore autem illum, saepe vero non nemo dolorem </p>
