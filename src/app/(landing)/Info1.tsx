  ...
  return (
    <div className="relative h-screen w-full overflow-hidden bg-gradient-to-r from-yellow-200 to-orange-400">
      ...
      <div className="absolute inset-0 bottom-20 z-20 flex items-center justify-center">
        <span className="absolute mx-auto flex w-fit select-none bg-gradient-to-l from-red-500 to-orange-500 bg-clip-text text-center text-4xl font-extrabold text-transparent blur-xl">
          Welcome to Edueme
        </span>
        <h1 className="relative top-0 flex h-auto w-fit select-auto bg-gradient-to-l from-red-400 to-orange-500 bg-clip-text text-center text-4xl font-extrabold text-transparent">
          Welcome to Edueme
        </h1>
      </div>
